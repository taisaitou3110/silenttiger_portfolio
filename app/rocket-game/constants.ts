...
export const LEVEL_CONFIGS: Record<number, LevelConfig> = {
  ...
  2: { name: "Lv.2: 山を越えろ", targetX: 1000, targetY: 350, drag: 0, obstacle: true, obstacleX: 400, obstacleWidth: 300, obstacleHeight: 300 },
  3: { name: "Lv.3: 高台のターゲット", targetX: 1000, targetY: 200, drag: 0, obstacle: false },
